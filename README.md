...
## Mock Web Service Calls
The web app uses [Mock Service Worker (MSW)](https://mswjs.io/) to mimic XHR responses during development.
It also uses MSW during the integration tests. More details about the mocks can be found
in `src/mocks`
